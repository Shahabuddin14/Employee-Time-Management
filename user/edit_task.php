    ...
    session_start();
     ...
     if(strlen($_SESSION['username'])==0){	
        ...
        if(isset($_POST['submit'])){
            ...
            $sql = mysqli_query($connection,"UPDATE  user_task SET start_time = now() WHERE id='$tid' ");
...
-->
                                        ...
                                        <button name="submit" id="login" class="btn btn-primary" type="submit" value="Update">Start time</button>
                                    </form>
                                </div>  
                            </div>
                        </div>
